...
100 users with an average of 10 friends means 1,000 directed connections to be made, but the way add_friendship works is that it makes a two way friendship, so you only need to call add_friendship 500 times. (1000/2)

2. If you create 1000 users with an average of 5 random friends each, what percentage of other users will be in a particular user's extended social network? What is the average degree of separation between a user and those in his/her extended network?

-Approximately 100% - 99.5% - Obviously worst case is 0% when the user doesn't have any friends.
...
all 2nd people (1st friends): 5\*5 = 25

3rd: 25 \*5 = 125

worst case:
You have five unique friends:

4 unique friends (1 being the orignal)
25 unique friends (4 being original)
100 unqiue friends (25 being original)
625
3125
15,000ish
